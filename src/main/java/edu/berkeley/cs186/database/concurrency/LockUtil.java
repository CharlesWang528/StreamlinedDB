...
public class LockUtil {
    ...
    public static void ensureSufficientIntent(LockContext lockContext, LockType requestType) {
        ...
        LockContext parentContext = lockContext.parentContext();
        LockType currentLockType = lockContext.lockman.getLockType(transactionContext, lockContext.name);
        ...
        if (!LockType.canBeParentLock(currentLockType, requestType)) {
            ...
            if (currentLockType == LockType.NL) {
                lockContext.acquire(transactionContext, requestIntent);
            } else {
                lockContext.promote(transactionContext, requestIntent);
            }
        }
